...
import type { PeriodStats } from "@app/hooks/stats/usePeriodStats";
...
const PeriodBreakdownTable = memo(
  ({ selectedPeriod, periodBreakdown, itemValues, getPeriodLabel }: PeriodBreakdownTableProps) => {
          ...
          {periodBreakdown.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>{periodHeading}</TableHead>
                    ...
                    return (
                      <React.Fragment key={periodData.periodKey}>
                        <TableRow
                          ...
                          onClick={() => togglePeriod(periodData.periodKey)}
                          ...
                          onKeyDown={e => {
                            if (e.key === "Enter" || e.key === " ") {
                              e.preventDefault();
                              togglePeriod(periodData.periodKey);
                            }
                          }}>
...
PeriodBreakdownTable.displayName = "PeriodBreakdownTable";
