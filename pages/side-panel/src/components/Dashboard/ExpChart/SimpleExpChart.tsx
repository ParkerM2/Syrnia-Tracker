...
import { Card, CardContent, CardHeader, CardTitle, ChartContainer, cn } from '@extension/ui';
...
const SimpleExpChart = memo(() => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="border-border bg-card relative w-full rounded-lg border p-4">
