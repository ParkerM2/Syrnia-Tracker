...
const JSONView = memo(({ rows }: { rows: CSVRow[] }) => {
  ...
  return (
    <div className="max-h-[600px] w-full overflow-auto">
      <div className="border-border relative rounded-lg border bg-slate-950 dark:bg-slate-900">
        {/* Header */}
        <div className="border-border sticky top-0 z-10 flex items-center justify-between border-b bg-slate-900 px-4 py-2 dark:bg-slate-800">
...
const DataView = memo(() => {
  ...
  if (error) {
    return (
      <div className={cn('text-destructive p-4 text-lg font-semibold')}>
    ...
    <div className={cn('flex flex-col gap-4')}>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          {/* View Mode Toggle */}
          <div className="border-border bg-card/50 flex items-center justify-between gap-4 rounded-lg border p-3">
            <div className="flex flex-1 flex-col gap-1">
              <Label htmlFor="view-mode" className="cursor-pointer text-base font-medium">
                View Mode
              </Label>
              <p className="text-muted-foreground text-sm">{viewMode === 'table' ? 'Table View' : 'JSON View'}</p>
            </div>
            <Switch
              id="view-mode"
