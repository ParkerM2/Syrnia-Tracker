...
import { GridViewIcon, SettingsIcon, TableViewIcon, ZoomInIcon, ZoomOutIcon } from '@src/assets/icons';
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <div className="flex min-w-0 flex-wrap gap-2">
              <select
                ...
                className={cn(
                  'border-input text-foreground ring-offset-background focus-visible:ring-ring bg-background flex h-10 min-w-[120px] max-w-[150px] flex-1 rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-[hsl(var(--secondary))]',
                )}>
