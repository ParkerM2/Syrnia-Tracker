import { UPDATE_SCREEN_DATA, UPDATE_USER_STATS, getTrackedData } from '@extension/shared';
import { TRACKED_DATA_QUERY_KEY } from '@extension/shared/lib/hooks/useTrackedDataQuery';
